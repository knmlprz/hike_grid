...
def generate_launch_description():
    trailblazer_cloud_path = get_package_share_directory('trailblazer_cloud')
    urdf_launch_dir = os.path.join(get_package_share_directory('depthai_descriptions'), 'launch')

    aligned_rviz = os.path.join(trailblazer_cloud_path,
                                'rviz', 'stereoInertialDepthAlignROS2.rviz')
    
    rectify_rviz = os.path.join(trailblazer_cloud_path,
    ...
    cam_pos_x    = LaunchConfiguration('cam_pos_x',     default = '0.0') #0.0475
    cam_pos_y    = LaunchConfiguration('cam_pos_y',     default = '0.0') #0.13
    cam_pos_z    = LaunchConfiguration('cam_pos_z',     default = '0.0') #0.4465
